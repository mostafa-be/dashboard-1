import { FolderKey, SquareChartGantt, WalletMinimal } from "lucide-react";
import React from "react";

type Props = {};

const CardProjectStatus = (props: Props) => {
  return (
      ...
      <div className="shadow bg-white p-2 rounded-2xl">
        <div className="flex gap-3 items-start justify-start">
          ...
          <div className="flex flex-col items-start justify-start">
            ...
            <p className="text-gray-700 text-sm mt-3">
              <span className="text-indigo-600">+8%</span> Running project
              increases
            </p>
          </div>
        </div>
        ...
        <div className="flex gap-3 items-start justify-start">
          <div className="p-2 rounded-lg bg-slate-100">
            <FolderKey className="text-gray-600" />
          </div>
          <div className="flex flex-col items-start justify-start">
            <h5 className="text-xl font-semibold">Private Projects</h5>
            <h5 className="text-2xl font-semibold mt-3 lining-nums">12</h5>
            <p className="text-gray-700 text-sm mt-3">
              <span className="text-indigo-600">+8%</span> Running project
              increases
            </p>
